...
function dsn_filters() {
  ...
  if (button_filter.length !== 0) {
    close.on("click", function () {
      ...
      box_filter.find("li").each(function () {
        tl.fromTo(
          ...
          0.3,
          { left: 0, opacity: 1 },
          { left: -40, opacity: 0, ease: Power1.easeIn }
        );
      });
    ...
    box_filter.find("li a").on("click", function (e) {
      ...
      if (filter === "*") {
        TweenMax.to(cat_filter.find(".cat-filter-item"), 0.5, {
          scale: 1,
        ...
        TweenMax.to(
          cat_filter.find(".cat-filter-item").not(".cat-filter-" + filter),
          0.5,
          {
            scale: 0,
            display: "none",
        ...
        TweenMax.to(
          cat_filter.find(".cat-filter-item" + ".cat-filter-" + filter),
          0.5,
          {
            scale: 1,
            display: "inline-block",
...
function loader() {
  ...
  $(window).on("load", function () {
    ...
    tl.to(".dsn-loader .dsn-progress-page", 0.7, { opacity: 0 })
      .to(".dsn-up", 2, { ease: Bounce.easeOut, top: "-50%" })
      .to(".dsn-down", 2, { ease: Bounce.easeOut, top: "100%" }, 0.7)
      .to(".dsn-loader", 0.1, { display: "none" });
    ...
    setTimeout(function () {
      ...
      t.fromTo(
        dsn_slider_info.find(".slide-meta li "),
        1,
        { opacity: 0, x: -40 },
        {
      ...
      t.fromTo(
        dsn_slider_info.find(".custom-btn"),
        1,
        { opacity: 0, x: -40 },
        {
          ease: Back.easeOut.config(4),
 ...
 */
function dsn_slider() {
  var dsn_slider_old = $(".dsn-grid-prev"),
  ...
  dsn_slider_current.on(
    ...
    function (event, slick, currentSlide, nextSlide) {
      ...
      dsn_slider_info
        .find(".dsn-grid-info-wrapper")
        .removeClass("dsn-slider-active");

      tlm_progress.reverse().progress(0.0);
      setTimeout(function () {
        tlm_progress.play();
      }, 500);
    }
  ...
  dsn_slider_current.on("afterChange", function (event, slick, currentSlide) {
    ...
    t2.fromTo(
      ...
      0.5,
      { opacity: 0, x: 0 },
      { opacity: 1, ease: Back.easeIn.config(4), x: -20 }
    );
    currentSlide++;
    ...
    t2.fromTo(
      ...
      1.5,
      { x: -20 },
      { ease: Back.easeOut.config(4), x: 0 }
    );
    ...
    active = dsn_slider_info.find(
      '[data-id="' + CurrentSlideDom.data("id") + '"]'
    );
  ...
  $("body").on("mousemove", function (e) {
    ...
    TweenMax.to(progress_slider, 0.5, {
      left: e.pageX - 15,
      top: e.pageY - 15,
    });
  });
...
function dsn_view_project(tlm_progress, progress_slider) {
  ...
  var dsn_info_click = dsn_info.find(
    ".dsn-grid-info-wrapper .title , .custom-btn"
  );
  ...
  dsn_info_click.on("click", function (e) {
    ...
    function beforeSend(id) {
      ...
      var header = $(
        '<header class="header-project cover-bg " data-overlay="2"></header>'
      );
      header.css({
        position: "absolute",
      ...
      body.append(header);
      tlMoveUp
        .staggerTo([dsn_info, dsn_info_prev, $(".dsn-grid-nav-box")], 1, {
        ...
        .to(header, 1, {
          ...
          left: 0,
          onStart: function () {
            TweenMax.to(dsn_info_current, 0.1, { opacity: 0 });
          },
          onComplete: function () {
            href = url;
...
function animation(remove) {
  ...
  TweenMax.fromTo(
    ...
    1,
    { opacity: 1, y: "100%" },
    { ease: Back.easeOut.config(1.7), opacity: 1, x: "-50%", y: "-50%" }
  );
...
function hoverReveal() {
  ...
  Array.from(
    document.querySelectorAll('[data-fx="1"] > a, a[data-fx="1"]')
